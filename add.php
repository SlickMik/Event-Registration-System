...
<body>
	...
	<div class="content">
		...
		<p>Please enter all fields and don't forget to provide a unique event ID</p>

        <form name="add" method="post" action="addV.php" onsubmit="return validateForm()">
        ...
        if ((document.add.event_id.value == "") ||(document.add.event_name.value == "")||(document.add.event_quota.value == "")) {
