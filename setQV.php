	...
	<div class="content">
        ...
        <?php
            ...
            if(mysqli_num_rows($result) > 0){
                $insert_sql="UPDATE event SET quota = '$quota' WHERE eventID='$eventID'";
                mysqli_query($con,$insert_sql);

                if($insert_sql){
                    echo"Successfully changed quota event.";
                    echo "<br><a href='setQ.php'>Return</a>";
                }
                else{
                    echo"Error in sql insertion.";
                    echo "<br><a href='setQ.php'> Please try again.</a>";
                }
            }
            else{
                echo"Error in changing event quota.";
                echo "<br><a href='setQ.php'> Please try again.</a>";
            }
        ?>
