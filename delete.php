...
<body>
	...
	<div class="content">
		<h2>Delete Registered User</h2>
		<p>Enter the desired user's id or username to delete them from the system </p>

        <form name="delete" method="post" action="deleteV.php" onsubmit="return validateForm()">
        ...
        if ((document.delete.id.value == "") && (document.delete.username.value == "")) {
